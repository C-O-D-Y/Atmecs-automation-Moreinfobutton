...
public class TestDataProvider {
	...
	/**
	 * In this method, getting the data of the footer into object array and
	 * returning to the calling method
	 */
	 ...
	 * returning to the calling method
	 */
	@DataProvider(name = "breadcrumbAndTitle")
	public Object[][] getBreadcrumbsAndTitle() {
		ProvideExcelData provideData = new ProvideExcelData(FilePath.TESTDATA_FILE, 6);
		Object[][] getData = provideData.provideExcelData();
		return getData;
	}
	 ...
	 */
	@Test(priority = 2, dataProvider = "breadcrumAndTitle", dataProviderClass = TestDataProvider.class)
